...
class CustomerIntelligenceAgent(BaseAgent):
    ...
    def execute(self, state: BrandIntelligenceState) -> BrandIntelligenceState:
        ...
        try:
            ...
            # Load brand metadata from Sheet1
            logger.info("Loading brand metadata from Sheet1...")
            brand_metadata = self._load_brand_metadata(brand_name)

            if not brand_metadata:
                logger.warning(f"Brand {brand_name} not found in Sheet1")
            ...
            # Load transaction data from Sheet2
            logger.info(f"Loading transaction data from Sheet2 for {brand_name}...")
    ...
    def _generate_markdown_report(
        ...
        lines.append(f"**Data Source:** Google Sheets - Sheet2")
        ...
        lines.append("")
        lines.append("**Data Source:** Google Sheets - Internal Operations Database (Sheet2)")
    ...
    def _generate_section_8(self, brand_name: str, metadata: Dict, data: Dict) -> List[str]:
        ...
        lines.append("")
        lines.append("**Source:** Google Sheets (Sheet2)")
        lines.append("")
        lines.append("```json")
        lines.append("{")
    ...
    def _generate_section_13(self, data: Dict) -> List[str]:
        ...
        lines.append("")
        lines.append("**Source:** Computed from Sheet2 transaction data")
        lines.append("")
    ...
    def _generate_section_14(self, data: Dict) -> List[str]:
        ...
        lines.append("")
        lines.append("**Source:** Computed from Sheet2 data availability")
        lines.append("")
        lines.append("```json")
        lines.append("{")
